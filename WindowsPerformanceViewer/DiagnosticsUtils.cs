...
using WindowsPerformanceViewer;
...
class DiagnosticsUtils {
    ...
    /// <summary>
    /// Returns a string with the given message and the message from the Exception.
    /// This is a local copy and should be removed eventially.
    /// </summary>
    /// <param name="msg"></param>
    /// <param name="ex"></param>
    /// <returns></returns>
    public static String excMsgLocal(String msg, Exception ex) {
    ...
    public static String readLog(String logName, int nToRead) {
        ...
        try {
            ...
            sb.AppendLine(excMsgLocal("Error in readDiagnostics", ex));
        }
        sb.AppendLine(SEPARATOR_LINE);
    ...
    public static String queryLogFileXml(String queryString, PathType type, String logName) {
        ...
        try {
            ...
            sb.AppendLine(excMsgLocal("Could not find the external log to query!", ex));
        } catch (Exception ex) {
            sb.AppendLine(excMsgLocal("Error in queryLogFileXml", ex));
        }
        sb.AppendLine(SEPARATOR_LINE);
